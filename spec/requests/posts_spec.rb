...
RSpec.describe 'Posts', type: :request do
  ...
  describe 'GET /post/{id}' do
    ...
    it 'should return a post' do
      ...
      expect(payload['id'].to_i).to eq(post.id)
  ...
  describe 'POST /posts' do
    ...
    it 'should create a post' do
      ...
      expect(payload).not_to be_empty
      expect(payload['id']).to be_truthy
  ...
  describe 'PUT /posts' do
    ...
    it 'should update a post' do
      ...
      expect(payload).not_to be_empty
      expect(payload['id'].to_i).to eq(article.id)
      expect(payload['title']).to eq(valid_payload(user)[:post][:title])
      expect(payload['body']).to eq(valid_payload(user)[:post][:body])
      expect(payload['status']).to eq(valid_payload(user)[:post][:status])
